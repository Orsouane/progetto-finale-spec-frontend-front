...
function SelectCategory({ filtredCategory, setSelect }) {
  return (
    <div>
      <select name="categories" id="categories" onChange={e => { setSelect(e.target.value) }} className=' bg-[#1F2937] rounded-md text-[#8E95A2] text-xs max-w-40 p-1 cursor-pointer '>
