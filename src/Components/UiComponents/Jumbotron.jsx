...
import { Gamepad, Circle, Triangle, Square, X } from 'lucide-react';
 function Jumbotron() {
      const offset = window.innerWidth < 600 ? 630 : window.innerWidth < 1024 ? 880 : 710 ;
     return (
          <div className="relative w-full h-[650px] sm:h-[880px] lg:h-[700px] overflow-hidden rounded-lg shadow-xl">
               ...
               <div className="absolute inset-0 overflow-hidden">
                    ...
                    <div className="absolute bottom-20 right-20 text-purple-300 opacity-20 transform rotate-45">
                         <Gamepad size={120} />
                    </div>

                    {/* X Button */}
                    <div className="absolute top-40 right-40 text-blue-300 opacity-30">
                         <X size={50} strokeWidth={3} />
                    </div>

                    {/* Triangle Button */}
                    <div className="absolute bottom-40 left-40 text-green-300 opacity-30">
                         <Triangle size={50} strokeWidth={3} fill="rgba(52, 211, 153, 0.2)" />
                    </div>

                    {/* Circle Button */}
                    <div className="absolute top-20 right-1/4 text-red-300 opacity-30">
                         <Circle size={40} strokeWidth={3} />
                    </div>

                    {/* Square Button */}
                    <div className="absolute bottom-20 left-1/4 text-pink-300 opacity-30">
