...
function DetailsPage() {
     ...
     return (
          <div className="m-5">
               ...
               <p className="text-white mt-2 py-2 bg-[#1F2937] p-2 max-w-[1200px] m-auto hover:border-[#8E95A2] rounded-xl hover:transform hover:-translate-y-1 transition-all duration-300 ease-out border border-gray-700/80 backdrop-blur-sm">
                    <span className="text-[#60A5FA] font-semibold">Description: </span>
               ...
               <div className="mt-2 bg-[#1F2937] flex flex-col rounded-xl p-2 gap-1 max-w-[1200px] m-auto hover:border-[#8E95A2] hover:transform hover:-translate-y-1 transition-all duration-300 ease-out border border-gray-700/80 backdrop-blur-sm">
                    <span className="font-bold text-[#60A5FA]">SystemRequirements : </span>
                    <span className="text-white">
                         <span className="text-stone-400 font-semibold"> Os : </span>{" "}
                         {gameDetail?.systemRequirements[0]}
                    </span>
                    <span className="text-white">
                         <span className="text-stone-400 font-semibold"> Cpu : </span>{" "}
                         {gameDetail?.systemRequirements[1]}
                    </span>
                    <span className="text-white">
                         <span className="text-stone-400 font-semibold"> Ram : </span>{" "}
                         {gameDetail?.systemRequirements[2]}
                    </span>
                    <span className="text-white">
                         <span className="text-stone-400 font-semibold"> Gpu : </span>{" "}
                         {gameDetail?.systemRequirements[3]}
                    </span>
               </div>
               ...
               <div className="flex flex-col p-2 gap-2 mt-2 bg-[#1F2937] max-w-[1200px] m-auto hover:border-[#8E95A2] rounded-xl hover:transform hover:-translate-y-1 transition-all duration-300 ease-out border border-gray-700/80 backdrop-blur-sm">
                    ...
                    <span className="font-bold text-stone-400 flex items-center gap-1">
                         Category :
                         <span className="text-white">{gameDetail?.category}</span>
                    </span>
                    <span className="font-bold text-stone-400 flex items-center gap-1">
                         Developer :
                         <span className="text-white">{gameDetail?.developer}</span>
                    </span>
                    <span className="font-bold text-stone-400 flex items-center gap-1">
                         ReleaseYear :
                         <span className="text-white">{gameDetail?.releaseYear}</span>
                    </span>
                    <span className="font-bold text-stone-400 flex items-center gap-1">
                         Tags :
                         <span className="text-white flex gap-3">
                              {gameDetail &&
                                   gameDetail.tags.map((el, index) => (
                                        <div key={index}>
                                             <span className="bg-[#1F2937] rounded-md text-[#8E95A2] border border-[#8E95A2] text-xs max-w-40 p-1">
                                                  {el}
                                             </span>
                                        </div>
                                   ))}
                    ...
                    <div className="flex justify-center items-center px-3 py-2 mt-2 bg-[#60A5FA] text-white font-semibold rounded-lg shadow-md transition duration-800 animate-pulse cursor-pointer">
