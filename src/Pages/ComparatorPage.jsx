      ...
      {savedGameCompare1 && savedGameCompare2 ? (
        <section className='max-w-[800px] m-auto text-xs sm:text-base mt-2'>
          <section className='flex justify-between gap-5'>
            <div className='text-sm max-w-92 shadow-2xl bg-[#1F2937] p-2 rounded-md hover:border-[#8E95A2] hover:transform hover:-translate-y-1 transition-all duration-300 ease-out border border-gray-700/80 backdrop-blur-sm'>
              ...
              <img src={savedGameCompare1.imagesExtra[0]} className='border-[#8E95A2] border shadow-2xl h-64' />
            ...
            <div className='text-sm max-w-92 shadow-2xl bg-[#1F2937] p-2 rounded-md hover:border-[#8E95A2] hover:transform hover:-translate-y-1 transition-all duration-300 ease-out border border-gray-700/80 backdrop-blur-sm'>
              ...
              <img src={savedGameCompare2.imagesExtra[0]} className='border-[#8E95A2] border shadow-2xl h-64' />
              <div className='grid sm:grid-cols-2 gap-2 pt-2'>
                {chiaveComparator.map((el, index) => (
                  <p key={index}>
                    <span className='text-[#60A5FA]'>{el.charAt(0).toUpperCase() + el.slice(1)} : </span>
              ...
              <table className='max-w-[450px] h-40 sm:h-58 text-center border-[#8E95A2]/20 border m-auto'>
                <thead className='border-[#8E95A2]/20 border shadow-2xl'>
                  <tr className='text-[#60A5FA]'>
                    <th>Game :</th>
                    <th className='w-35 p-2'>{savedGameCompare1.title}</th>
                    <th className='w-35'>{savedGameCompare2.title}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
