          ...
          <div className='m-5  '>
                    ...
                    <div className='bg-[#1F2937] p-3 rounded-md mt-10 flex justify-center flex-col text-sm sm:text-base max-w-[820px] m-auto hover:border-[#8E95A2]  transition-all duration-300 ease-out border border-gray-700/80 backdrop-blur-sm h-72 sm:h-full'>
                         <div className="sm:flex  gap-2  mt-2 ">
                              ...
                              <div className="animate-pulse bg-gray-300 max-w-[500px] h-[500px] w-[500px]  m-auto rounded-md"></div>
                              </div>
                              {/* Miniatura */}

                              <div className="  sm:w-1/4 flex sm:flex-col gap-2 p-1 border-y border-y-gray-600 rounded-md scroll-container     ">
                                   <div className="animate-pulse bg-gray-300 max-w-[400px] m-auto h-20 w-35 rounded-md "></div>
                                   <div className="animate-pulse bg-gray-300 max-w-[400px] m-auto h-20 w-35 rounded-md "></div>
                                   <div className="animate-pulse bg-gray-300 max-w-[400px] m-auto h-20 w-35 rounded-md "></div>
                                   <div className="animate-pulse bg-gray-300 max-w-[400px] m-auto h-20 w-35 rounded-md "></div>
                              </div>
               ...
               <div className='text-white mt-2 py-2 bg-[#1F2937] p-2 max-w-[1200px]  m-auto hover:border-[#8E95A2]  rounded-xl
                           hover:transform hover:-translate-y-1 
                           transition-all duration-300 ease-out
                           border border-gray-700/80
                           backdrop-blur-sm'>  <p className="animate-pulse bg-gray-300 w-60 h-5 rounded-md mb-1 "></p></div>
